...
function MarketSection() {
  return (
    <section id="market" data-screen-label="04 Market">
      <div className="section__inner">
        ...
        <PullQuote cite="UM point of view · 2026 Upfronts">
...
function CTVSection() {
  return (
    <section id="ctv" className="sec--sand" data-screen-label="05 CTV">
      <div className="section__inner">
        <SectionHead
          num="03"
...
function LinearSection() {
  return (
    <section id="linear" className="sec--dark" data-screen-label="06 Linear">
      <div className="section__inner">
        <SectionHead
          num="04"
...
function SportsSection() {
  const { worldCup, rightsMoves } = SPORTS_DATA;
  return (
    <section id="sports" data-screen-label="07 Sports">
      <div className="section__inner">
        <SectionHead
          num="05"
          kicker="Sports · The Last Driver of Scale"
          title={<>Live Sports Is The<br />Final Mass Medium.</>}
          lede="Every other category of programming is fragmenting. Sports is the only category where simultaneous mass audiences still assemble. In 2026, that scarcity gets priced — hard."
        />
        ...
        <div className="split-2-3" style={{marginBottom: 80}}>
          <div>
            <div style={{
              ...
              <span style={{color: 'var(--um-red)'}}>FIFA World Cup</span><br />
              2026.
            </div>
